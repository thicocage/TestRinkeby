              ...
              <ul className="">
                <li>
                  <p className="text-base leading-normal text-gray-600 mt-4">
                    ...
                    users can buy, own, and trade. While some NFT&#8242;s
                    function as digital art, they can also offer additional
                    benefits like exclusive access to websites, event tickets,
                    game items, and ownership records for physical objects.
                    Think of it as a unique piece of art that can also serve as
                    a one&#8211;of&#8211;a&#8211;kind
                    &#8220;members&#8211;only&#8220; card.
                  </p>
                </li>
          ...
          <div className="bg-white shadow rounded p-8 mt-8">
            ...
            {faq3 && (
              <ul>
                <li>
                  <p className="text-base leading-normal text-gray-600 mt-4 ">
                    You can buy as many as you want with the limit of 10 per
                    transaction.
                  </p>
                </li>
              </ul>
