              ...
              <div className="py-8 space-y-4 text-base leading-6 text-gray-700 sm:text-lg sm:leading-7">
                <ul className="space-y-2 list-disc">
                  ...
                  <li className="flex items-start">
                    ...
                    <p className="ml-2">8000 randomly generated C.Y.B.Rs</p>
                  </li>
                  <li className="flex items-start">
                    <span className="flex items-center h-6 sm:h-7">
                      <svg
                    ...
                    <p className="ml-2">Dystopian universe.</p>
                  </li>
                  <li className="flex items-start">
                    <span className="flex items-center h-6 sm:h-7">
                      <svg
                    ...
                    <p className="ml-2">0.2 ETH per C.Y.B.Rs.</p>
                  </li>
                </ul>
              </div>
              <div className="pt-6 text-base leading-6 font-extralight sm:text-lg sm:leading-7">
                <p>
                  In a dystopian universe, human race set out to find a new home
                  in space in order to survive. The special suits they designed
                  using next-level technology allowed them to wander distant
                  lands. They have finally discovered an ancient planet with
                  great hopes. However, they are unaware of what awaits them...
                </p>
                <p className="mt-8">
                  <Link href="#main">
